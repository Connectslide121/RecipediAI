  ...
  return (
    <section>
      ...
      <div className="nutrition-page-wrapper">
        <p>Fill the form below to get health tips and recipe suggestions</p>
        <div className="nutrition-content-wrapper">
          ...
          <div className="nutrition-results">
            <div className="nutrition-result-line">
              ...
              />
              <h4>BMI:</h4>
              {height !== 0 && weight !== 0 && age !== 0 && <p>{bmi}</p>}
            </div>
            <div className="nutrition-result-line">
              <TooltipIcon
                icon={<FontAwesomeIcon icon={faCircleQuestion} />}
              ...
              />
              <h4>BMI CLASS:</h4>
              {height !== 0 && weight !== 0 && age !== 0 && <p>{bmiClass}</p>}
            </div>
            <div className="nutrition-result-line">
              <TooltipIcon
                icon={<FontAwesomeIcon icon={faCircleQuestion} />}
              ...
              />
              <h4>BMR:</h4>
              {height !== 0 && weight !== 0 && age !== 0 && <p>{bmr}</p>}
            </div>
            <div className="nutrition-result-line">
              <TooltipIcon
                icon={<FontAwesomeIcon icon={faCircleQuestion} />}
        ...
        {height !== 0 && weight !== 0 && age !== 0 && (
          <NutritionRecommendation bmiClass={bmiClass} />
        )}
      </div>
    </section>
  );
