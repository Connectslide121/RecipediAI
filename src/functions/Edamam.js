...
export async function GetRecipeByDishType(dishType) {
  const response = await axios
    .get(
      `https://api.edamam.com/api/recipes/v2?type=public&dishType=${dishType}&random=true&imageSize=LARGE&app_id=63572ae8&app_key=80bdf734c856159f004aca67212196ba`
    )
...
export async function GetRecipesByQuery(query) {
  const response = await axios
    .get(
      `https://api.edamam.com/api/recipes/v2/?type=public&${query}&random=true&imageSize=LARGE&app_id=63572ae8&app_key=80bdf734c856159f004aca67212196ba`
    )
    .catch(function (error) {
